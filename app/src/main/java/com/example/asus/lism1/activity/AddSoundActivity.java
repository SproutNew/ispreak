...
public class AddSoundActivity extends Activity {
    ...
    private boolean doStart() {
        ...
        try {
            ...
            Toast.makeText(AddSoundActivity.this, "录音失败，请重试", Toast.LENGTH_SHORT).show();
            return false;
        }
    ...
    public void playrecorder(View view) {
        if (!mIsPlaying) {
            ...
            Toast.makeText(AddSoundActivity.this, "正在播放", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        try {
            ...
            mediaPlayer.setOnErrorListener(new MediaPlayer.OnErrorListener() {
                ...
                public boolean onError(MediaPlayer mp, int what, int extra) {
                    stopPlayer();
                    Toast.makeText(AddSoundActivity.this,"播放失败",Toast.LENGTH_SHORT).show();
                    return true;
                }
            });
